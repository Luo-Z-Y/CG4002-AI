...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--voice-mean", default=str(Path("../data/audio/combined/voice_mean.npy")))
    parser.add_argument("--voice-std", default=str(Path("../data/audio/combined/voice_std.npy")))
